                ...
                <div class="container sidecenterright"> 
                	<?  
						...
						if (isset($arOwaesTypes[$strType])) {
							echo ("<h1>" . $arOwaesTypes[$strType] . " toevoegen <small>(credits " . ((owaesType($strType)->direction()==DIRECTION_EARN) ? "verdienen" : "uitgeven") . ")</small></h1>"); 
						} else {
							echo ("<h1>Aanbod toevoegen</h1>"); 
						}  
					?>
                	...
                	<div class="owaesadd">
                        <div class="left">
                            <div class="authorimg"><? echo $oOwaesItem->author()->getImage("60x60"); ?></div> 
                        </div>
                        <form method="post" id="frmowaesadd" name="frmowaesadd">  
                        	<ol class="addtabs">
                            	<li class="actief"><a href="#algemeen">Algemeen</a></li>
                            	<li><a href="#plaatsentijd">Plaats en tijd</a></li>
                            	<li><a href="#compensatie">Compensatie</a></li>
                            </ol> 
                            <dl id="algemeen">
                            	<? 
                                ...
                                <dd><input type="text" name="title" id="title" class="required" value="<? echo inputfield($oOwaesItem->title()); ?>" /></dd>
        						...
        						<dd class="buttons">
                                	<a href="#plaatsentijd" class="volgende">volgende</a>
                                </dd>
                            </dl>
                             
                            <dl id="plaatsentijd"> 
                                <dt><label for="location">Plaats</label></dt>
                                <dd><input type="radio" name="location" id="locationfixed" value="fixed" class="required auto" <? if ($oOwaesItem->location()!="") echo ('checked="checked"'); ?> /> <label for="locationfixed">Op locatie</label></dd>
                                <dd class="locationfixed">
                                    <input type="text" name="locationfixed" class="locationfixed_required" id="location" value="<? echo inputfield($oOwaesItem->location()); ?>" />
                                ...
                                <dd><input type="radio" name="location" id="locationfree" value="free" class="required auto" <? if ($oOwaesItem->location()=="") echo ('checked="checked"'); ?> /> <label for="locationfree">Vrij te kiezen</label></dd>
         
                            
                                <dt><label for="timing">Tijdstip</label></dt>
                                <dd><input type="radio" name="timing" id="timingfixed" value="fixed" class="required auto" <? if (count($oOwaesItem->data())>0) echo ('checked="checked"'); ?> /> <label for="timingfixed">Vast</label></dd>
                                ...
                                <dd><input type="radio" name="timing" id="timingfree" value="free" class="required auto" <? if (count($oOwaesItem->data())==0) echo ('checked="checked"'); ?> /> <label for="timingfree">Vrij te kiezen</label></dd>
                                <dd><input type="radio" name="timing" id="timingtbc" value="tbc" class="required auto" /> <label for="timingtbc">nog te bepalen</label></dd>
                                
                                <dt><label for="timing">Tijdsduur</label></dt>
                                <dd><input type="text" min="0" max="10" class="required auto border" name="timingtime" id="timingfreeslide" value="<? echo $oOwaesItem->timing(); ?>" /></dd>

        						<dd class="buttons">
                                	<a href="#algemeen">vorige</a>
                                	<a href="#compensatie" class="volgende">volgende</a>
                                </dd>
                           </dl>
                           ...
                           <dl id="compensatie">
        						...
        						<dd class="buttons">
                                	<a href="#plaatsentijd">vorige</a>
                                	<input type="submit" name="owaesadd" id="owaesadd" class="auto border" value="opslaan" />
                                </dd>
                            </dl>

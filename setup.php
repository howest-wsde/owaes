<?php
	...
	if (isset($_POST["domainname"])) {
		$oDB = new database(); 
		$oDB->execute("update `tblConfig` set value = '" . $oDB->escape($_POST["domainname"]) . "' where `key` = 'domain.name' and `value` = NULL; "); 
		$oDB->execute("update `tblConfig` set value = '" . $oDB->escape($_POST["domainroot"]) . "' where `key` = 'domain.root' and `value` = NULL; "); 
		$oDB->execute("update `tblConfig` set value = '" . $oDB->escape($_POST["domainabsroot"]) . "' where `key` = 'domain.absroot' and `value` = NULL; "); 
		redirect("login.php"); 
	}
